...
with open('test_csi2_long_frame_raw10_4lane.vcd', 'r') as f:
    content = f.read()
...
with open('test_csi2_long_frame_raw10_4lane_500ps.vcd', 'w') as f:
    f.write(content)

print("Converted VCD with 500ps timescale created as test_csi2_long_frame_raw10_4lane_500ps.vcd")