...
with open('test_csi2_long_packet.vcd', 'r') as f:
    content = f.read()
...
with open('test_csi2_long_packet_500ps.vcd', 'w') as f:
    f.write(content)

print("Converted VCD with 500ps timescale created as test_csi2_long_packet_500ps.vcd")